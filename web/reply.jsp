...
<body>
	...
	<div id="main">
        ...
        <div id="log">
			<form id="loginForm" action="<%=request.getContextPath()%>/RepltServlet" method="post">
			...
			<div id="cmopd">
				<ul>
					...
					<li><strong class="lts">回复内容：</strong><textarea name="msgreply" id="msgreply" class="ltxs"><%=request.getParameter("msgreply")==null?"":request.getParameter("msgreply")%></textarea></li>
				</ul>
			</div>
			<div id="cfopd">
				<input type="button" class="btn_sub" value="回复" onclick="check_post_valid1()" />
